...
//       {isEditMode && isActive && meshRef.current && (
//         <TransformControls
...
//                 {isEditMode && (
//                   <div className="absolute top-4 right-4 bg-white rounded-lg shadow-xl p-4 z-10">
//                     <div className="flex items-center justify-between mb-3">
...
//                         className={`flex-1 px-4 py-2 rounded-lg font-medium transition-colors ${editTarget === 'text'
...
//                         className={`flex-1 px-4 py-2 rounded-lg font-medium transition-colors ${editTarget === 'image'
...
//                       <span>
//                         Use the transform controls (arrows) in the 3D view to move the {editTarget}.
//                         Click and drag the colored arrows to reposition.
//                       </span>
//                     </div>

//                     <div className="mt-3">
//                       <div className="text-xs font-semibold text-gray-600 mb-2">
//                         {editTarget === 'text' ? 'Text Position' : 'Image Position'}
//                       </div>
//                       <div className="grid grid-cols-3 gap-2 text-xs">
//                         <div className="text-center bg-gray-50 rounded p-2">
//                           <div className="font-semibold text-gray-600">X</div>
//                           <div className="font-mono text-gray-900">
//                             {editTarget === 'text'
//                               ? (textPosition?.[0]?.toFixed(2) || '16.00')
//                               : (imagePosition?.[0]?.toFixed(2) || '16.00')}
//                           </div>
//                         </div>
//                         <div className="text-center bg-gray-50 rounded p-2">
//                           <div className="font-semibold text-gray-600">Y</div>
//                           <div className="font-mono text-gray-900">
//                             {editTarget === 'text'
//                               ? (textPosition?.[1]?.toFixed(2) || '9.80')
//                               : (imagePosition?.[1]?.toFixed(2) || '9.80')}
//                           </div>
//                         </div>
//                         <div className="text-center bg-gray-50 rounded p-2">
...
//                           <div className="font-mono text-gray-900">
//                             {editTarget === 'text'
//                               ? (textPosition?.[2]?.toFixed(2) || '5.00')
//                               : (imagePosition?.[2]?.toFixed(2) || '4.80')}
//                           </div>
//                         </div>
//                       </div>
//                     </div>
...
// CODE 5 WITH EDIT MOVE AND SCALE FUNCTIONALITY
